...
export const DemoModal: React.FC<DemoModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xl animate-fade-in">
      <div className="relative w-full max-w-lg bg-[#061c0e] border border-[#1f794d]/60 rounded-3xl shadow-[0_0_50px_rgba(78,228,139,0.2)] overflow-hidden">
        {/* Header */}
        <div className="px-6 py-4 border-b border-[#1f794d]/30 flex items-center justify-between bg-[#05160b]">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-lg bg-[#092915] text-[#4ee48b] border border-[#1f794d]">
        ...
        <div className="p-6">
          {submitted ? (
            <div className="py-8 text-center space-y-3">
              <CheckCircle2 className="w-12 h-12 text-[#4ee48b] mx-auto" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-[#05160b] border border-[#1f794d]/40 text-white text-xs focus:border-[#4ee48b] focus:outline-none"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-xl bg-[#05160b] border border-[#1f794d]/40 text-gray-200 text-xs focus:border-[#4ee48b] focus:outline-none"
                >
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 rounded-xl bg-[#4ee48b] hover:bg-[#38d677] text-[#05160b] font-bold text-xs sm:text-sm shadow-xl shadow-[#4ee48b]/20 transition-all cursor-pointer active:scale-95 disabled:opacity-50"
                >
              ...
              <div className="text-center text-[11px] font-mono text-gray-400 flex items-center justify-center gap-1 pt-1">
                <Lock className="w-3 h-3 text-[#4ee48b]" />
